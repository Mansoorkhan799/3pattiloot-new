...
export const metadata: Metadata = {
  title: 'Disclaimer – 3 Patti Loot | Legal Information 2026',
  description: 'Read the disclaimer for 3 Patti Loot. Important legal information about the use of this blog and third-party platforms.',
  keywords: ['3 Patti Loot disclaimer', 'legal disclaimer', 'terms', 'conditions', 'gambling disclaimer'],
  openGraph: {
    title: 'Disclaimer – 3 Patti Loot | Legal Information 2026',
    description: 'Legal disclaimer and important information about 3 Patti Loot.',
    url: 'https://3patti-loot.com.pk/disclaimer',
    siteName: '3 Patti Loot',
    type: 'website',
    images: [{ url: 'https://3patti-loot.com.pk/3-patti-loot.webp', width: 1200, height: 630, alt: '3 Patti Loot Disclaimer' }],
  },
  twitter: {
    card: 'summary',
  ...
  alternates: {
    canonical: 'https://3patti-loot.com.pk/disclaimer',
  },
  robots: {
    index: true,
    follow: true,
...
export default function Disclaimer() {
  return (
    <div className="min-h-screen bg-primary py-12 px-4">
      <script type="application/ld+json" dangerouslySetInnerHTML={{ __html: JSON.stringify({ "@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{ "@type": "ListItem", "position": 1, "name": "Home", "item": "https://3patti-loot.com.pk/" }, { "@type": "ListItem", "position": 2, "name": "Disclaimer", "item": "https://3patti-loot.com.pk/disclaimer" }] }) }} />
            ...
            <div className="prose prose-lg max-w-none">
              ...
              <div className="space-y-6 text-gray-300">
                <p className="text-lg leading-relaxed">
                  The information provided on this blog (<a href="https://www.3patti-loot.com.pk" className="text-accent hover:text-accent font-semibold" target="_blank" rel="noopener noreferrer">www.3patti-loot.com.pk</a>) about <Link href="/" className="text-accent hover:underline font-semibold">3 Patti Loot</Link> is for <strong>general informational and entertainment purposes only</strong>. We do not host, promote, or encourage any form of gambling or betting activities.
                </p>
                ...
                <div className="bg-[#0A1029] rounded-xl p-6 border border-accent">
                  ...
                  <ul className="space-y-3 text-gray-300">
                    <li className="flex items-start">
                      ...
                      <span>3 Patti Loot is a card game that may involve <strong>real money</strong> when played on certain platforms.</span>
                    </li>
                    <li className="flex items-start">
                      <span className="text-accent mr-2 font-bold">•</span>
      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            "@type": "WebPage",
            "name": "Disclaimer - 3 Patti Loot",
            "description": "Legal disclaimer and important information about 3 Patti Loot website.",
            "url": "https://3patti-loot.com.pk/disclaimer"
          })
        }}
      />
